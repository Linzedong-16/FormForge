...
export default function (): Status {
  return {
    ...
    status: {
      title: {
        id: uuidv4(),
        status: t("components.defaultStatus.optionSelectTitle"),
        isShow: true,
        name: "title-editor",
      ...
      desc: {
        id: uuidv4(),
        status: t("components.defaultStatus.optionSelectDesc"),
        isShow: true,
        name: "desc-editor",
      ...
      options: {
        id: uuidv4(),
        currentStatus: 0,
        status: [t("components.defaultStatus.optionSelect1"), t("components.defaultStatus.optionSelect2")],
        isShow: true,
        name: "options-editor",
