...
export const childrenRoutes: RouteRecordRaw[] = [
  ...
  // ═══════════════════════════════════════════════════════════
  // 4. AI 问卷分析 — Agent 自主分析对话（仅超级管理员）
  // ═══════════════════════════════════════════════════════════
  {
    path: "/agent-analysis",
    name: "agentAnalysis",
    component: () => import("../views/agent-analysis/AgentAnalysisView.vue"),
    meta: {
      title: "AI 问卷分析",
      icon: "robot",
  ...
  // ═══════════════════════════════════════════════════════════
  // 6. 用户管理 — 用户列表 CRUD（角色/权限 mock 页面已移除）
  // ═══════════════════════════════════════════════════════════
  {
