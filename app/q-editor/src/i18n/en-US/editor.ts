export default {
  ...
  inputGroup: "Input",
  noteGroup: "Notes",
  personalInfoGroup: "Personal Info",
  contactGroup: "Contact",

  // Selection types
  singleSelect: "Single Choice",
  singlePicSelect: "Picture Single",
  multiSelect: "Multiple Choice",
  multiPicSelect: "Picture Multiple",
  ...
  optionsEdit: "Options",
  requiredEdit: "Required",
  positionEdit: "Position",
  sizeEdit: "Size",
  weightEdit: "Weight",
  italicEdit: "Italic",
  colorEdit: "Color",
  textTypeEdit: "Text Type",
  textInputTypeEdit: "Input Type",
  dateTimeTypeEdit: "Date Type",
  rateTextEdit: "Rating Text",
  sliderConfigEdit: "Slider Config",
  matrixOptionsEdit: "Matrix Options",
  cascaderOptionsEdit: "Cascade Options",
  picOptionsEdit: "Picture Options",
